...
/**
 * CouponDetailUsedControllerTest
 * @author 김민규
 * @since 2022.10.25
 * @version 1.0
 * 
...
public class CouponDetailUsedControllerTest {
	...
	public void TestEventdetailView() throws Exception{
		log.info(mockMvc.perform(MockMvcRequestBuilders.get("/mypage/mycouponUsed").param("MID", "team5")).andReturn().getModelAndView().getModelMap());
	}
