  ...
  $.flexslider = function(el, options) {
        ...
        setupPaging: function() {
          ...
          if (slider.pagingCount > 1) {
            for (var i = 0; i < slider.pagingCount; i++) {
              item = (vars.controlNav === "thumbnails") ? '<img src="' + slider.slides.eq(i).attr("data-thumb") + '" alt="' + slider.slides.eq(i).attr("data-alt") + '" />' : '<a>' + j + '</a>';// 20130829
																																																	// �섏젙
    ...
    slider.flexAnimate = function(target, pause, override, withSync, fromNav) {
      ...
      // if (asNav && slider.pagingCount === 1) slider.direction =
		// (slider.currentItem < target) ? "next" : "prev"; (20130802 bak)
	  if (asNav) slider.direction = (target > slider.currentSlide) ? "next" : "prev";// 20130802
																						// �섏젙
