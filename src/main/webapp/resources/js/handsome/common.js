(function($) {
	$(document).ready(function() {
		...
		/*
		 * $('#view_category').click(function(){ $('#category_layer').show();
		 * $(this).fadeOut('fast', function(){ $('#category').animate({left:0},
		 * 'fast', function(){ $('#category a.close').fadeIn('fast'); });
		 * $('#contents').animate({marginLeft:227}, 'fast');
		 * //$('#fixed_cont').animate({marginRight:-867}, 'fast'); }); //ddddd =
		 * 1; return false; }); $('#category a.close').click(function(){
		 * $('#category_layer').hide(); $('#category a.close').fadeOut('fast',
		 * function(){ $('#contents').animate({marginLeft:0}, 'fast');
		 * $('#category').animate({left:-227}, 'fast', function(){
		 * $('#view_category').fadeIn('fast'); });
		 * //$('#fixed_cont').animate({marginRight:-640}, 'fast'); }); //ddddd =
		 * 0; return false; }); $('#category_layer').click(function(){
		 * $('#category_layer').hide(); $('#category a.close').fadeOut('fast',
		 * function(){ $('#contents').animate({marginLeft:0}, 'fast');
		 * $('#category').animate({left:-227}, 'fast', function(){
		 * $('#view_category').fadeIn('fast'); });
		...
		$('#view_smenu').mouseleave(function() {
			 ...
			 * $('#women_sub').stop(false, true).slideUp('fast');
			 * $('#view_smenu').find('img').attr('src',
			 * '../images/header_sub1.jpg'); } ); $('#women_sub').mouseleave(
			 * function(){ $(this).stop(false, true).slideUp('fast');
			 * $('#view_smenu').find('img').attr('src',
			 * '../images/header_sub1.jpg'); } );
			 */
		/*
		 * $('#header_menu').click(function(){ return false; });
		 */
		...
		/*
		 * $('#dress_sub1').mouseenter(function(){ $('#women_sub
		 * a.dsub').css({display:'none'}); $('#women_sub
		 * a.dsub1').css({display:'block'}); });
		 */
	});
