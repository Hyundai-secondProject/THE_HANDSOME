...
<link rel="stylesheet" type="text/css"
	href="/_ui/desktop/common/css/common.css?20220929" media="all" />
<link rel="stylesheet" type="text/css"
	href="/_ui/desktop/common/css/layout.css?20220826" media="all" />
<link rel="stylesheet" type="text/css"
	href="/_ui/desktop/common/css/popup.css?20210225" media="all" />
<link rel="stylesheet" type="text/css"
...
<link rel="stylesheet" type="text/css"
	href="/_ui/desktop/common/css/footer.css?20220406" media="all" />
<link rel="stylesheet" type="text/css"
	href="/_ui/desktop/common/css/contents.css?20220907" media="all" />
...
<script type="text/javascript"
	src="/_ui/desktop/common/js/handsome/ui.js?20211105"></script>
<script type="text/javascript"
	src="/_ui/desktop/common/js/jquery.form-3.51.js"></script>
<script type="text/javascript"
	src="/_ui/desktop/common/js/common_function.js?20220411"></script>
<script type="text/javascript"
...
// 								html.push('<li><a href="http://www.thehyundai.com/front/dpm/myShopHome.thd?bfp=Ref_Handsome">트렌드샵</a></li>');
	...
	<form id="CSRFForm"
		action="/ko/mypage/order/myorderdetail?code=221012P15336437"
		method="post">
		<div>
...
function callChatbot(token, talkId) {
    if(token == null) {
        $.ajax({
            ...
            data: {"CSRFToken":"c8d6b9e8-78d2-4ad0-b447-31354e623e97"},
            async : false,
            success:function(data){
...
$(document).ready(function() {
    ...
    if("PASS" != ""){
	    ...
	    if ((vipPassCheck == "Y" || timePassCheck == "Y") && "myOrderDetailPage" == "main201903Page") {
	        $('#chatbotMain').show(); 
	    }else{
	        $('#chatbotMain').hide(); 
	    }
				...
				<div class="top_nav_wrap clearfix">
					...
					<div class="search_box_wrap sbw1803" id="searchBox">
						<form name="search" id="search" action="/ko/hssearch/searchCount"
							...
							<input type="hidden" name="CSRFToken"
								value="c8d6b9e8-78d2-4ad0-b447-31354e623e97" /> <input
...
<div class="popwrap w_type_4" id="addrModPop" style="display: none;">
			...
			<table class="tbl_wtype1">
				...
				<tbody>
					...
					<tr>
						...
						<td><input type="text" name="lastname" id="name" title="수령인"
	...
	<!-- //Table -->
	<div class="btnwrap">
		<input class="btn wt_s" value="취소" type="button" id="cancleBtn" /> <input
...
<div class="popwrap w_type_4" style="display: none;"
		...
		<form id="addrModForm"
			...
			<table class="tbl_wtype1">
				...
				<tbody>
					...
					<tr>
						<th scope="row"><strong class="reqd">*</strong><label
							for="name" style="line-height: 17px;">checkout.shipto.contactname.english</label></th>
						<td><input value=""
					...
					<tr>
						<th scope="row"><strong class="reqd">*</strong><label
							for="localLastName" style="line-height: 17px;">checkout.shipto.contactname.local</label></th>
	...
	<!-- //Table -->
	<div class="btnwrap">
		<input class="btn wt_s mr0" value="취소" type="button" id="cancleBtn" />
...
<div class="popwrap w_type_5" style="display: none;"
	id="cancelRefundAmountLayer">
	<!-- Title1 -->
	...
	<div class="tblwrap">
		<table class="tbl_ltype payment_info">
			...
			<thead>
				<tr>
					<th scope="col">기 결제 금액<span class="ico_minus">minus</span></th>
					<th scope="col">취소/반품이 반영된 잔액<span class="ico_equals">equals</span></th>
			...
			<tbody>
				<tr>
					<td class="frt">
						<ul class="price_info">
							<li><em>판매가</em> <span>₩ 27,000</span></li>
							<li><em>쿠폰할인</em> <span><span class="minus">-</span>
									₩ 0</span></li>
							<li><em>플러스쿠폰 할인</em> <span><span class="minus">-</span>
									₩ 0</span></li>
							<li><em>한섬 VVIP 혜택 할인</em> <span><span class="minus">-</span>
									₩ 0</span></li>
							<li><em>배송비</em> <span>₩ 2,500</span></li>
							<li>&nbsp;</li>
							<li><em><b>합계</b></em> <span><b>₩ 29,500</b></span></li>
						</ul>
					</td>
					<td>
						<ul class="price_info">
							<li><em>판매가</em> <span> ₩ 0</span></span></li>
							<li><em>쿠폰할인</em> <span><span class="minus">-</span>
									₩ 0</span></li>
							<li><em>플러스쿠폰 할인</em> <span><span class="minus">-</span>
									₩ 0</span></li>
							<li><em>한섬 VVIP 혜택 할인</em> <span><span class="minus">-</span>
									₩ 0</span></li>
							<li><em>배송비</em> <span>₩ 0</span></li>
							<li>&nbsp;</li>
							<li><em><b>합계</b></em> <span><b>₩ 0</b></span></li>
						</ul>
					</td>
					<td>
						<ul class="price_info">
							<li><em>전체 환불 금액</em> <span> ₩ 29,500</span></li>
							<li><em>환불 한섬 VVIP 혜택</em> <span>₩ 0</span></li>
						</ul>
					</td>
				</tr>
				<tr>
					<td class="frt">
						<ul class="price_info">
							<li><em>한섬마일리지</em> <span>0 M</span></li>
							<li><em>H.Point</em> <span>0P</span></li>
							<li><em>기프트 카드</em> <span> ₩ 0</span></li>
							<li><em>e-money</em> <span> ₩ 0</span></li>
							<li><em>주 결제 금액</em> <span> ₩ 29,500</span></li>
						</ul>
					</td>
					<td>
						<ul class="price_info">
							<li><em>한섬마일리지</em> <span>0 M</span></li>
							<li><em>H.Point</em> <span>0 P</span></li>
							<li><em>기프트 카드</em> <span> ₩ 0</span></li>
							<li><em>e-money</em> <span> ₩ 0</span></li>
							<li><em>주 결제 금액</em> <span> ₩ 0</span></li>
						</ul>
					</td>
					<td>
						<ul class="price_info">
							<li><em>환불 마일리지</em> <span> 0 M</span></li>
							<li><em>환불 H.Point</em> <span> 0 P</span></li>
							<li><em>환불 기프트 카드</em> <span>₩ 0</span></li>
							<li><em>환불 e-money</em> <span>₩ 0</span></li>
							<li><em>주 결제 환불 금액</em> <span class="total"> ₩ 29,500</span>
							</li>
						</ul>
					</td>
				</tr>
	...
	<div class="title_wrap mt50">
		...
		<p class="guide_comment">
			취소/반품 시 쿠폰 적용 조건이 충족하지 않아, 쿠폰이 환급되지 않습니다.
			<!-- 상품 취소/반품으로 인하여 해당쿠폰의 적용조건이 일치하지 않아 쿠폰 혜택이 적용되지 않았습니다. -->
		</p>
	</div>
	<!-- Table -->
	<div class="tblwrap">
		<table class="tbl_wtype1 mt10">
			<caption>복원된 쿠폰 내역</caption>
			<colgroup>
				<col style="width: 25%">
				<col style="width: 75%">
			</colgroup>
	...
	<dl class="gd_list com pl0">
		...
		<dd>
			<ul class="bul_sty01_li">
				...
				<li>쿠폰 기간 만료 시 환급되어도 사용 불가하며, 자세한 사항은 ‘마이페이지>쿠폰’ 메뉴에서 확인하실 수
					있습니다.</li>
				<li>쿠폰 적용 여부에 따라서 취소/반품 신청하신 상품의 판매가 보다 환불금액이 작을 수 있습니다.</li>
				<li>특정 구매금액 이상일 때 적용되는 쿠폰의 경우 환불로 인해 구매금액이 감소할 때 쿠폰 적용이 취소될 수
					있습니다.</li>
				...
				<li>환불 시 결제수단별 환불 순서는 다음과 같습니다.<br> 1.주결제 수단 환불 2. 기프트카드
					환급 3. 한섬마일리지 환급
				</li>
			</ul>
		</dd>
	...
	<!-- //Guide Table -->
	<div class="btnwrap mt0 ">
		<input type="button" class="btn gray_s mr0 okBtn " value="확인" />
	</div>
