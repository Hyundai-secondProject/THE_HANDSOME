...
<title>
	&#44060;&#51064;&#51221;&#48372; &#48320;&#44221; &#48708;&#48128;&#48264;&#54840; &#52404;&#53356; | &#45908;&#54620;&#49452;&#45815;&#52980;</title>
<link rel="shortcut icon" href="http://cdn.thehandsome.com/resources/images/common/thehandsome_ic_16x16.ico" />
...
<link rel="stylesheet" type="text/css" href="/resources/css/layout.css?20221020" media="all" />
...
<script type="text/javascript">
		...
		var ACC = { config: {} };
			...
			ACC.config.CSRFToken = "3933d641-ecc6-4db9-908d-aef169481ba7";
...
//     var startDate = new Date('2018/03/23 00:00:00'), endDate = new Date('2018/04/08 23:59:59');
    ...
    if (todayDate.getTime() >= startDate.getTime() && todayDate.getTime() <= endDate.getTime()) {
        ...
        var uid = "hsPersonInfomationChangePWCheckPage";
...
//                         console.log(data);
                         ...
                         if(data != "11") {
                             ...
                             innerHtml += '        <a href="javascript:mapleEvtPopClose()" alt="닫기" class="close" style="background:url(\'http://cdn.thehandsome.com/resources/images/common/btn_close.png\') no-repeat; display:block; position:absolute; bottom:2px; right:6px; width:11px; height:11px; z-index:2;">&nbsp;</a>';
                             innerHtml += '    </div>';
                             innerHtml += '</div>';
...
try{
	var birthday = 'Mon Mar 23 00:00:00 UTC 1998';
...
//             console.log(data);
            ...
            if(data == "anonymous") {
                    ...
                    innerHtml += '       <img src="http://cdn.thehandsome.com/resources/images/event/202209_maple/evt_maple_202209_pc_pop_login.jpg" alt="오늘의 단풍잎">';
                    ...
                    innerHtml  = '<div class="popwrap_maple_evt2209" style="height:319px;">';
                    innerHtml += '   <div class="check_my_maple" style="position:relative">';
                    innerHtml += '       <img src="http://cdn.thehandsome.com/resources/images/event/202209_maple/evt_maple_202209_pc_pop_login02_1.jpg" alt="오늘의 단풍잎">';
                    ...
                    innerHtml += '   <div class="check_my_maple" style="position:relative">';
                    innerHtml += '       <img src="http://cdn.thehandsome.com/resources/images/event/202209_maple/evt_maple_202209_pc_pop_todayend.jpg" alt="내일 다시 참여해보세요">';
                    ...
                    if(item == "1" || item == "2" || item == "3" || item == "4") {
                        innerHtml += '    <img src="http://cdn.thehandsome.com/resources/images/event/202209_maple/evt_maple_202209_pc_pop_red.jpg" alt="행운의 황금 단풍잎을 획득하셨습니다.">';
                    }else if(item == "5" || item == "6" || item == "7") { 
                        innerHtml += '    <img src="http://cdn.thehandsome.com/resources/images/event/202209_maple/evt_maple_202209_pc_pop_green.jpg" alt="행운의 황금 단풍잎을 획득하셨습니다.">';
                    }else if(item == "8" || item == "9" || item == "10") {
                        innerHtml += '    <img src="http://cdn.thehandsome.com/resources/images/event/202209_maple/evt_maple_202209_pc_pop_brown.jpg" alt="행운의 황금 단풍잎을 획득하셨습니다.">';
                    }
...
<input type="hidden" name="CSRFToken" value="3933d641-ecc6-4db9-908d-aef169481ba7" />
</div></form><!-- headerWrap -->
		<div id="headerWrap" >
...
function callChatbot(token, talkId) {
    if(token == null) {
        $.ajax({
            ...
            data: {"CSRFToken":"3933d641-ecc6-4db9-908d-aef169481ba7"},
            async : false,
            success:function(data){
...
$(document).ready(function() {
    ...
    //vip 채팅 서비스
    if("" != ""){
	    var pag = "hsPersonInfomationChangePWCheckPage";
	    ...
	    if ((vipPassCheck == "Y" || timePassCheck == "Y") && "hsPersonInfomationChangePWCheckPage" == "main201903Page") {
	        $('#chatbotMain').show(); 
	    }else{
	        $('#chatbotMain').hide(); 
	    }
                    ...
                    <div class="data_react">
                        ...
                        <div class="search_tab">
                            ...
                            <form id="searchStyle" name="searchStyle" action="/ko/hssearch/searchCount" method="post" onsubmit="return false;">
                                ...
                                <input type="hidden" name="collection" value=""/>
                                <input type="hidden" id="CSRFToken" name="CSRFToken" value="3933d641-ecc6-4db9-908d-aef169481ba7" />
				...
				<div class="honey_talk_service1905 remove1907"><!-- 추가 190702 -->
	                ...
	                <div id="chatbotMain" style="display:none;">
	                    ...
	                    <a href="#none" class="btn_viptalk_v2 v3" onclick="callChatbot();GA_Event('공통','유틸_메뉴','하니톡');">
	                        <img src="http://cdn.thehandsome.com/resources/images/main/talk-talk-chat-icon.png">
	                    </a>
	                </div>
	                <!-- //vip 채팅 서비스 -->
	            </div>
...
$(document).ready(function(){
	...
	$("#login_btn").click(function(){
		...
		if(vc.isValid()){
		    ...
		    $.ajax({
				type:"post",
				url:"/ko/common/passwordrecheck" + "?callPage=mypage",
				data:{"uid":$("#j_username").val(), "pw":pw , "CSRFToken" :"3933d641-ecc6-4db9-908d-aef169481ba7"},
				success:function(response){
					if(response==true){
					    $("#personInfomationChangePage").attr("action", "/ko/mypage/personInfomationChange");
						$("#personInfomationChangePage").submit();
					}else{
					    location.href="/ko/mypage/personInfomationChangePWCheck?error=true";
					}
				},
				error:function(e){
					console.log(e);
                ...
                <div class="login_section">
                    ...
                    <div>
                        <div>
                            ...
                            <input type="text" id="j_username" name="j_username" value="sks*********" disabled="disabled" />
                        </div>
                        <div>
...
function uploadFilesubmit(writeType, returnType) {
	...
	if ( fileSize <= 1 ) {
		...
		$.ajax({
			url	 : url + '?CSRFToken=3933d641-ecc6-4db9-908d-aef169481ba7',
			type	: 'POST',
			dataType: 'json',
			data	: param,
			success : function(data) {
...
//	reviewhtml += "                                             </button>";
	...
	reviewhtml += "         </fieldset>";
	reviewhtml += " </div>";
	reviewhtml += "     <a href='javascript:void(0);' id='reviewCloseBtn' style='position: absolute; top: 20px; right: 20px; width: 20px; height: 20px;'><img src='/resources/images/popup/ico_close.png' alt='닫기'></a>";
	reviewhtml += "</div>";
	reviewhtml += "</form>";
	reviewhtml += "</div>";
...
<div id="footerWrap">
	<div id="topBtn">
		<a href="javascript:void(0);" class="viewTopArea"><img src="http://cdn.thehandsome.com/resources/images/common/top_btn.png" alt="맨 위로" onclick="GA_Event('공통','퀵버튼','TOP');"/></a>
	</div>
	<div class="footer">
		<!--footer_cnts1 -->
		<div class="footer_cnts1 clearfix">
			...
			<div class="footer_menu cnts1_left">
				<div class="footer_logo"><a href="/ko/main" onclick="GA_Event('공통','로고','하단');"><img src="http://cdn.thehandsome.com/resources/images/common/footer_logo_renew.png" alt="HANDSOME" /></a></div>
...
<img src="http://cdn.thehandsome.com/resources/images/common/footer_ico_apps.png" alt="APP 다운로드" style="width:52px;height:71px;">
<!-- 				        <img src="/resources/images/common/ico_apps_new.png" alt="APP 다운로드" style="width:54px;height:70px;"> -->
<p>APP 다운로드 &gt;</p>
			        </a>
