...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/common.css" media="all" />
    ...
    <script type="text/javascript">
        ...
        ACC.config.CSRFToken = "c8d6b9e8-78d2-4ad0-b447-31354e623e97";
...
<![endif]-->
    ...
    <script type="text/javascript">
        var setDimensionData = function () {
            ...
            pageviewObj.dimension14 = "20221006"; //고객_회원가입일
    ...
    <script>
        $(document).ready(function () {
            ...
            var startDate = new Date(testDt),
                endDate = new Date('2018/04/08 23:59:59');
            ...
            if (todayDate.getTime() >= startDate.getTime() && todayDate.getTime() <= endDate.getTime()) {
                ...
                if (getCookie('blossomsPopup') != todayDate.getDate()) {
                    if (viewYn == true && ranYn == true) {
                        var innerHtml =
                            "<div class=\"evtpop_blsm_0314\" style=\"position:fixed;top:220px;left:80px;margin-left:0;z-index:15;background:url('http://cdn.thehandsome.com/pc/event/detail/image/evt_blsmbg_180321.png') 8px 2px no-repeat;width:100px;height:110px;\">";
                        innerHtml += "  <div class=\"blsmflw1\" style=\"position:absolute;\">";
                        innerHtml +=
                            "      <img src=\"http://cdn.thehandsome.com/Mobile/event/detail/image/m_evt_blsm2_180321.png\" alt=\"꽃잎줍기\">";
                        innerHtml += "  </div>";
                        innerHtml += "  <a href=\"javascript:blossomsEvent(\'" + type +
                            "\');\" alt=\"이벤트GO\" style=\"display:block;position:absolute;top:10px;width:110px;height:85px;\">&nbsp;</a>";
                        innerHtml +=
                            "  <a href=\"javascript:blossomsClose(\'close'\);\" alt=\"꽃잎close\" style=\"background:url('/_ui/desktop/common/images/common/btn_close.png') no-repeat;display:block;position:absolute;top:0;right:-7px;width:18px;height:18px;z-index:2;\">&nbsp;</a>";
                        innerHtml += "  <div style=\"position:absolute;bottom:-4px;left:17px;width:120px;\">";
                        innerHtml +=
                            "      <label for=\"day_close\" style=\"cursor:pointer;text-decoration:underline;color:#6e6e6e;letter-spacing:-.5px;\" onclick=\"blossomsClose(\'day_close\');\">하루 보지 않기</label>";
                        innerHtml +=
                            "      <input id=\"day_close\" type=\"checkbox\" name=\"day_close\" value=\"하루 보지 않기\" onclick=\"blossomsClose(\'day_close\');\" style=\"display:none;\">";
                        innerHtml += "  </div>";
                        innerHtml += "</div>";
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (data != "11") {
                                    ...
                                    innerHtml += '    </div>';
                                    innerHtml +=
                                        '    <div class="today_close" style="position:absolute;bottom:0;left:6px;width:134px;">';
                                    innerHtml +=
                                        '        <label for="justDay1" style="cursor:pointer;color:#000;letter-spacing:-.5px;">오늘 하루 보지 않기</label>';
                                    innerHtml +=
                                        '        <input id="justDay1" type="checkbox" name="day_close" value="오늘 하루 보지 않기" style="display:none">';
                                    innerHtml +=
                                        '        <a href="javascript:mapleEvtPopClose()" alt="닫기" class="close" style="background:url(\'http://cdn.thehandsome.com/_ui/desktop/common/images/common/btn_close.png\') no-repeat; display:block; position:absolute; bottom:2px; right:6px; width:11px; height:11px; z-index:2;">&nbsp;</a>';
                                    innerHtml += '    </div>';
                                    innerHtml += '</div>';
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data == "nextTime") { //오늘의 썸머 캐리어가 꽉 찼습니다. 내일 다시 썸머아이템을 찾아주세요. 
                                ...
                                var tp = ($(window).height() - obj.outerHeight()) / 2 + $(window)
                                    .scrollTop();
                                if (tp < 0) tp = 0;
                                obj.css("top", tp);
                                obj.show();
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data == "nextTime") { //내일 다시 
                            ...
                            } else if (item == "brown1" || item == "brown2" || item == "brown3" || item ==
                                "brown4") {
        ...
        try {
            var birthday = 'Mon Nov 16 00:00:00 UTC 1998';
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data == "anonymous") {
                        ...
                        innerHtml +=
                            '       <img src="http://cdn.thehandsome.com/_ui/desktop/common/images/event/202209_maple/evt_maple_202209_pc_pop_login.jpg" alt="오늘의 단풍잎">';
                        innerHtml +=
                            '       <a href="/ko/magazine/events/8804481881984/login" style="width:160px;height:40px;text-indent:-9999px;position:absolute;top:208px;left:120px;display:block">로그인 바로가기</a>';
                        innerHtml +=
                            '       <a href="javascript:mapleEvtPopClose()" class="btn_close_oneday" style="position:absolute;width:130px;height:30px;bottom:25px;left:135px;text-indent:-9999px;display:block">오늘 하루 보지 않기</a>';
                        innerHtml += '   </div>';
                        innerHtml +=
                            '   <a href="javascript:mapleEvtPopClose(\'close\')" class="btn_close"></a>';
                        innerHtml += '</div>';
                        ...
                        innerHtml += '   <div class="check_my_maple" style="position:relative">';
                        innerHtml +=
                            '       <img src="http://cdn.thehandsome.com/_ui/desktop/common/images/event/202209_maple/evt_maple_202209_pc_pop_login02_1.jpg" alt="오늘의 단풍잎">';
                        innerHtml +=
                            '       <a href="https://www.h-point.co.kr/cu/join/start.nhd" style="width:160px;height:40px;text-indent:-9999px;position:absolute;top:208px;left:120px;display:block">통합회원 가입하기</a>';
                        innerHtml +=
                            '       <a href="javascript:mapleEvtPopClose()" class="btn_close_oneday" style="position:absolute;width:130px;height:30px;bottom:25px;left:135px;text-indent:-9999px;display:block">오늘 하루 보지 않기</a>';
                        innerHtml += '   </div>';
                        innerHtml +=
                        ...
                        innerHtml += '   <div class="check_my_maple" style="position:relative">';
                        innerHtml +=
                            '       <img src="http://cdn.thehandsome.com/_ui/desktop/common/images/event/202209_maple/evt_maple_202209_pc_pop_todayend.jpg" alt="내일 다시 참여해보세요">';
                        innerHtml +=
                            '       <a href="javascript:mapleEvtPopClose()" class="btn_close_oneday" style="position:absolute;width:130px;height:30px;bottom:34px;left:135px;text-indent:-9999px;display:block">오늘 하루 보지 않기</a>';
                        innerHtml += '   </div>';
                        ...
                        if (item == "1" || item == "2" || item == "3" || item == "4") {
                            innerHtml +=
                                '    <img src="http://cdn.thehandsome.com/_ui/desktop/common/images/event/202209_maple/evt_maple_202209_pc_pop_red.jpg" alt="행운의 황금 단풍잎을 획득하셨습니다.">';
                        } else if (item == "5" || item == "6" || item == "7") {
                            innerHtml +=
                                '    <img src="http://cdn.thehandsome.com/_ui/desktop/common/images/event/202209_maple/evt_maple_202209_pc_pop_green.jpg" alt="행운의 황금 단풍잎을 획득하셨습니다.">';
                        } else if (item == "8" || item == "9" || item == "10") {
                            innerHtml +=
                                '    <img src="http://cdn.thehandsome.com/_ui/desktop/common/images/event/202209_maple/evt_maple_202209_pc_pop_brown.jpg" alt="행운의 황금 단풍잎을 획득하셨습니다.">';
                        }

                        innerHtml +=
                            '        <a href="javascript:mapleEvtPopClose(\'close\')" style="width:170px;height:40px;text-indent:-9999px;position:absolute;bottom:77px;left:28px">계속 쇼핑</a>';
                        innerHtml +=
                            '        <a href="javascript:goMapleEvent()" style="width:170px;height:40px;text-indent:-9999px;position:absolute;bottom:77px;right:28px">나의 단풍 나무 확인하기</a>';
                        innerHtml +=
                            '        <a href="javascript:mapleEvtPopClose()" class="btn_close_oneday" style="position:absolute;width:130px;height:30px;bottom:35px;left:135px;text-indent:-9999px;display:block">오늘 하루 보지 않기</a>';
                        innerHtml += '    </div>';
                        innerHtml +=
                            '    <a href="javascript:mapleEvtPopClose(\'close\')" class="btn_close"></a>';
                        innerHtml += '</div>';
    ...
    <!-- End of Groobee -->
    <meta property="groobee:member_id" content="98seoeun@naver.com" />
...
<body oncontextmenu='return false'>
    ...
    <script>
        (function () {
            if (document.cookie.indexOf('thehyundai=true') > -1) {
                ...
                html.push(
                    '<a href="http://www.thehyundai.com/Home.html?bfp=Ref_Handsome" class="logo">THE HYUNDAI</a>'
                );
                html.push('<ul>');
                html.push(
                    '<li><a href="http://www.thehyundai.com/front/dpa/searchSpexSectItem.thd?sectId=100004&bfp=Ref_Handsome">더드림딜</a></li>'
                );
                html.push(
                    '<li><a href="http://www.thehyundai.com/front/dpa/storPiupSearchSect.thd?bfp=Ref_Handsome">스토어픽</a></li>'
                );
                html.push(
                    '<li><a href="https://www.thehyundai.com/CS/eva/evntBnftPageDivide.thd?tabNo=1&bfp=Ref_Handsome">이벤트/혜택</a></li>'
                );
                html.push(
                    '<li><a href="https://www.thehyundai.com/front/dpv/vrList.thd?bfp=Ref_Handsome">VR스토어</a></li>'
                );
    ...
    <form id="CSRFForm" action="/ko/mypage" method="post">
        <div>
            <input type="hidden" name="CSRFToken" value="c8d6b9e8-78d2-4ad0-b447-31354e623e97" />
        </div>
    </form><!-- headerWrap -->
    <div id="headerWrap">
        <div class="header header_fixed header_main1903">
                ...
                function callChatbot(token, talkId) {
                    if (token == null) {
                        $.ajax({
                            ...
                            data: {
                                "CSRFToken": "c8d6b9e8-78d2-4ad0-b447-31354e623e97"
                            },
                            async: false,
                            success: function (data) {
            ...
            <script type="text/javascript">
                ...
                function setOneDayCookie(cName, cValue, cDay) {
                    ...
                    var expire = new Date(currentDate.getFullYear(), currentDate.getMonth(), currentDate.getDate() +
                        cDay, 0, 0, 0);
                    cookies = cName + '=' + escape(cValue) + '; path=/ ';
                    if (typeof cDay != 'undefined') cookies += ';expires=' + expire.toGMTString() + ';';
                    document.cookie = cookies;
                ...
                $(document).ready(function () {
                    ...
                    if (todayDate.getTime() >= startDate.getTime() && todayDate.getTime() <= endDate
                        .getTime()) {
                    ...
                    if (getCookie("ie8AlertHideYN") != "on") {
                        if (navigator.appVersion.indexOf('MSIE 8.0') >= 0 || navigator.appVersion.indexOf(
                                'Trident/4.0') >= 0) {
                            var html =
                        ...
                        for (var j = 0; j < arr.length; j++) {
                            if (arr_date[i] != "") {
                                if (arr[j].indexOf(arr_date[i]) > 0) {
                                    ...
                                    $("#searchWord" + (i + 1)).next().attr("onclick",
                    ...
                    if ("PASS" != "") {
                        ...
                        var chkPag = ["svCenterMainPage", "noticePage", "manToManInquiryPage", "faqPage",
                            "mendingPage", "vocProvisionPage", "vocInfoFormPage", "memberJoinGuidePage",
                            "theClubInfoPage",
                            "memberBenefitGuidePage", "pointGuidePage", "couponGuidePage",
                            ...
                            if (!$('.search_box_wrap').hasClass('on')) {
                                ...
                                $(document).find('#styleSearchSlider').flexslider({
                                    ...
                                    after: function (slider) {
                                        $("#styleSearchSlider .slides li").not(
                    ...
                    <div class="search_box_wrap sbw1803" id="searchBox">
                        <form name="search" id="search" action="/ko/hssearch/searchCount" method="post"
                            ...
                            <div class="search_box">
                                ...
                                <a href="javascript:GA_search();doSearch();" class="search"><span
                                        class="ico">검색</span></a>
                            </div>
                        </form>
                        <!--검색박스 활성화 data_react -->
                        <div class="data_react">
                            ...
                            <div class="search_tab">
                                ...
                                <!-- style search -->
                                <form id="searchStyle" name="searchStyle" action="/ko/hssearch/searchCount"
                                    method="post" onsubmit="return false;">
                                    <input type="hidden" name="query" value="" />
                                    <input type="hidden" name="collection" value="" />
                                    <input type="hidden" id="CSRFToken" name="CSRFToken"
                                        value="c8d6b9e8-78d2-4ad0-b447-31354e623e97" />
                                ...
                                <div class="list">
                                    <ul>
                                        ...
                                        <li><a href="/ko/mypage/voucher"
                                                onclick="GA_Event('공통','헤더_메뉴','마이페이지_쿠폰조회')">쿠폰조회
                                                <!-- 쿠폰조회 --></a></li>
            ...
            <div class="sub_cnts">
                ...
                <script type="text/javascript">
                    ...
                    $(document).ready(function () {
                        ...
                        orderList.setRowHtml = function (results) {
                            ...
                            $.each(results, function () {
                                ...
                                listTag += '<td rowspan="' + this.entries.length +
                                    '" class="frt"><p class="num">' + this.code + '</p>';

                                listTag += '<span class="sum_date">(' + this.orderCreateDate +
                                    ')</span>';
                                listTag += '<a href="/ko/mypage/order/myorderdetail?code=' + this
                                    .code +
                                    '" class="btn_view" onclick="GA_Event(\'마이페이지\',\'최근주문\',\'상세보기\');">상세보기</a>'; //상세보기
                                ...
                                $.each(this.entries, function () {
                                    ...
                                    var reOrderInfoPrintYn = (this.reOrderYn && (this
                                        .orderStatus.code == "PAYMENT_CAPTURED" ||
                                        this.orderStatus.code ==
                                        "SHIPPING_PREPARATION" || this.orderStatus
                                        .code == "DEPOSIT_WAIT")); // 예약주문관련 안내메시지 노출 여부
                                    var reOrderCompleteYn = (this.reOrderYn && (this
                                        .orderStatus.code == "PAYMENT_CAPTURED"
                                    )); // 예약주문완료 주문상태
                                    ...
                                    if (this.product.productImages != null) {
                                        $.each(this.product.productImages, function () {
                                            if (orderThis.egiftCardOrderYn ==
                                                true) {
                                                if (this.imageDivisionCode.code ==
                                                    'T01') {
                                    ...
                                    if (orderThis.egiftCardOrderYn == true) {
                                        entryTag +=
                                            '   <a href="#;"  style="pointer-events: none;" onclick="GA_Event(\'마이페이지\',\'최근주문\',\'' +
                                            escape(this.product.name) + '\');"><img src="' +
                                            productImageUrl + '" alt="상품 이미지"></a>    ';
                                        entryTag +=
                                            '   <div class="tlt_wrap">                                                                        ';
                                        entryTag +=
                                            '       <a href="#;"  style="pointer-events: none;" class="basket_tlt" onclick="GA_Event(\'마이페이지\',\'최근주문\',\'' +
                                            escape(this.product.name) +
                                            '\');">                                                           ';
                                    } else {
                                        entryTag += '   <a href="/ko/p/' + this.product
                                            .code +
                                            '" onclick="GA_Event(\'마이페이지\',\'최근주문\',\'' +
                                            escape(this.product.name) + '\');"><img src="' +
                                            productImageUrl + '" alt="상품 이미지"></a>    ';
                                        entryTag +=
                                            '   <div class="tlt_wrap">                                                                        ';
                                        entryTag += '       <a href="/ko/p/' + this.product
                                            .code +
                                            '" class="basket_tlt" onclick="GA_Event(\'마이페이지\',\'최근주문\',\'' +
                                            escape(this.product.name) +
                                            '\');">                                                           ';
                                        entryTag += '           <span class="tlt">[' + this
                                            .product.brandName + ']</span>';
                                    }

                                    if (reserveSaleYn) {
                                        entryTag +=
                                            '           <span class="sb_tlt"><b>[예약판매]</b> ' +
                                            this.product.name + '</span>';
                                    } else {
                                        entryTag += '           <span class="sb_tlt">' +
                                            this.product.name + '</span>';
                                    }
                                    ...
                                    if (typeof freeGiftList != "undefined" && freeGiftList
                                        .length > 0 && this.freeGiftCommentYN) {
                                        ...
                                        if (this.returnStatus != null && this.returnStatus
                                            .code != 'RETURN_CANCEL') {
                                            commentShowYn = false;
                                        }
                                        ...
                                        if (commentShowYn) {
                                            entryTag +=
                                                '<p class="guide_comment2">※ 사은품 안내 사항은 ‘주문상세’를 확인해주세요.</p>';
                                        }
                                    }
                                    ...
                                    if (reOrderInfoPrintYn) {
                                        ...
                                        deliveryplanDateMsg = deliveryplanDateMsg.replace(
                                            '{0}', yyyy);
                                        deliveryplanDateMsg = deliveryplanDateMsg.replace(
                                            '{2}', dd);
                                    ...
                                    if (orderThis.deliveryKind == "QUICK") {
                                        ...
                                        entryTag += '   </div>';
                                    } else if (orderThis.deliveryPointOfService != null || (
                                            orderThis.deliveryPointOfService != "" &&
                                            typeof orderThis.deliveryPointOfService !=
                                            "undefined")) {
                                        entryTag += '   <div class="option_wrap">';
                                        entryTag +=
                                            '       <p class="store_pickup stk">매장수령</p>';
                                        entryTag += '   </div>';
                                    }
                                    ...
                                    entryTag += '<td>'
                                    if (this.partCancelYn == true) entryTag += '<del>' +
                                        this.originalQuantity + '</del>';
                                    entryTag += this.quantity + '</td>';


                                    entryTag += '<td>₩ ' + addComma(this.totalPrice.value) +
                                        '</td>';
                                    entryTag += '<td>';
                                    ...
                                    if (this.orderStatus.code == "DEPOSIT_WAIT" || this
                                        .orderStatus.code == "PAYMENT_CAPTURED" || this
                                        .orderStatus.code == "DELIVERY_COMPLETED" || this
                                        .orderStatus.code == "NOT_PAID_CANCEL" || this
                                        .orderStatus.code == "CANCELLED" || this.orderStatus
                                        .code == "CANCELLING") {
                                        if (reOrderInfoPrintYn) {
                                    ...
                                    if (this.partCancelYn == true && this.orderStatus
                                        .code != "CANCELLED") {
                                    ...
                                    if (orderThis.deliveryKind != "AT_HOME" && orderThis
                                        ...
                                        if (this.orderStatus.code == "SHIPPED" || this
                                            .orderStatus.code == "DELIVERY_COMPLETED") {
                                            if (this.returnStatus == null) {

                                                entryTag +=
                                                    '<br /><a href="#" class="btn wt_ss shippingInfoBtn" ocode="' +
                                                    orderThis.code + '" pcode="' + this
                                                    .product.code + '" >배송조회</a>' //배송조회
                                    ...
                                    if (this.orderStatus.code == "DEPOSIT_WAIT") {
                                        actionBtn +=
                                            '<a href="/ko/mypage/order/cancelrequest?code=' +
                                            orderThis.code +
                                            '&isall=Y" class="btn wt_ss">전체취소</a>'; //전체취소
                                    } else if (this.orderStatus.code ==
                                        "PAYMENT_CAPTURED") {
                                        if (orderThis.redVoucherOrderYn == true) {
                                            ...
                                            actionBtn += '<div class="btn_wrap">' +
                                                searchDeliveryTemp + tempCancel;
                                            if (orderThis.egiftCardOrderYn == true &&
                                                orderThis.egiftBuySmsReSendAvailableYn ==
                                                true) {
                                                tempCancel =
                                                    '<a href="javascript:eGiftBuySmsReSend(this,\'' +
                                                    orderThis.code + '\',\'' + orderThis
                                                    .egiftCardCode +
                                                    '\');" id="reSendEGift" class="btn wt_ss" style="margin-top:10px;min-width:69px;">1회 재전송</a>';
                                                actionBtn += searchDeliveryTemp +
                                                    tempCancel + '</div>';
                                            } else if (orderThis.egiftCardOrderYn == true &&
                                                orderThis.egiftBuySmsReSendAvailableYn !=
                                                true) {
                                                tempCancel =
                                        ...
                                        if (orderThis.egiftCardOrderYn != true) {
                                            ...
                                            if (this.returnAvailYn == true) {
                                                ...
                                                if (orderThis.deliveryKind == "AT_HOME" && (
                                                        this.returnYN == true || this
                                                        .returnYN == "true")) {

                                                } else {
                                                    <
                                                    !--반품 중지 인 경우와 반품 상태가 없는 경우 반품 신청 버튼이 나옴
                                                        .반품 완료지만 수량이 남아 있을 경우 반품 신청 버튼이 나오지만 확인 후 수량이 없을 경우 다음으로 이동하지 않음 khg START--
                                                        >
                                                        if (this.returnStatus != null) {
                                            ...
                                            if (this.product.approvalStatus == "approved" &&
                                                this.returnStatus == null) {
                                                if (this.reviewWriteYn != null) {
                                                    if (this.reviewWriteYn == "Y") {
                                                        var color = this.product
                                                            .baseOptions[1].selected
                                                            .erpColorName;
                                                        var price = this.totalPrice.value;
                                                        var brandName = this.product
                                                            .brandName;
                                                        ...
                                                        actionBtn +=
                                                            ...
                                                            '\', \'' + productName.replace(
                                                                /\'/g, "\\\'") + '\', \'' +
                                                            categoryCode +
                                                            '\', \'myMain\')" class="btn wt_ss">상품평 작성</a>'; //상품평쓰기
                                                    }
                                                }
                                            } else if (this.product.approvalStatus ==
                                                "approved" && this.returnStatus != null && (
                                                    this.returnStatus.code ==
                                                    "RETURN_CANCEL" || this.returnStatus
                                                    .code == "RETURN_COMPLETED")) {
                                                if (this.reviewWriteYn != null) {
                                                    if (this.reviewWriteYn == "Y") {
                                                        var color = this.product
                                                        ...
                                                        var categoryCode = this.product
                                                            .actualMeasurementSizeCode.code;
                                                        var orderNumber = this.code;
                                                        if (reviewReturnConfirm(orderThis
                                                                .code) == "T") {
                                                            actionBtn +=
                                                                '<a href="javascript:openPopupReview(\'' +
                                                                this.product.code +
                                    ...
                                    if (addrModifyAvailYn) {
                                        if (isFirstCheck) {
                                            ...
                                            var ph = ['', '', ''];
                                            var email = ['', ''];
                                            if (orderThis.cellphone != null) hp = orderThis
                                                .cellphone.split('-');
                                            if (orderThis.phone1 != null) ph = orderThis
                                                .phone1.split('-');
                                            if (orderThis.email != null) email = orderThis
                                                .email.split('@');
                                            searchDeliveryTemp +=
                                                '<a href="javascript:void(0);" class="btn wt_ss addrModBtn" code="' +
                                                orderThis.code + '" addr1="' + orderThis
                                                .address1 + '" addr2="' + orderThis
                                                .address2 + '" zip="' + orderThis.zipCode +
                                                '" rcname="' + orderThis.name + '" hp1="' +
                                                hp[0] + '" hp2="' + hp[1] + '" hp3="' + hp[
                                                    2] + '" ph1="' + ph[0] + '" ph2="' + ph[
                                                    1] + '" ph3="' + ph[2] + '" or="' +
                                                orderThis.deliveryRequestContents +
                                                '" emailId="' + email[0] +
                                                '" emailDomain="' + email[1] +
                                                '" >배송정보수정</a>'; //배송지 수정
                        ...
                        orderList.afterSetAction = function () {
                            $('.addrModBtn').click(function () {
                                ...
                                if (getByteLength($(this).attr('rcname')) > 40) {
                                    $l.find('#name').val(subStringBytes($(this).attr('rcname'), 40,
                                        3));
                                } else {
                                ...
                                $l.find('#findAddrBtn').click(function () {
                                    searchAddressLayer('addrModPop_clone #address1',
                                        'addrModPop_clone #address2',
                                        'addrModPop_clone #zipCode');
                                });
                                ...
                                $l.find('#orderr').focus(function () {
                                    ...
                                    $l.bind('click', function (e) {
                                        if ($(e.target).parents("#orderrArea")
                                            .size() == 0) {
                                            $l.find('.delivery_comt').hide();
                                            $l.unbind('click');
                                        };
                                ...
                                $l.find('#applyBtn').click(function () {
                                    var vc = new ValidationCheck(
                                        'addrModPop_clone #addrModForm');
                                    vc.checkIdList = ['zipCode', 'address1', 'address2',
                                        'name', 'hp1', 'hp2', 'hp3'
                                    ];
                                    if (vc.isValid()) {

                                        $l.find("#hp").val($l.find("#hp1").val() + "-" + $l
                                            .find("#hp2").val() + "-" + $l.find("#hp3")
                                            .val());
                                        $l.find("#ph").val($l.find("#ph1").val() + "-" + $l
                                            .find("#ph2").val() + "-" + $l.find("#ph3")
                                            .val());

                                        $l.find("#email").val($l.find("#emailId").val() +
                                            "@" + $l.find("#emailDomain").val());
                            ...
                            $(".shippingInfoBtn").click(function () {
                                var paramDatas = 'ocode=' + $(this).attr('ocode') + '&pcode=' + $(
                                    this).attr('pcode');
                                ...
                                $.ajax({
                                    ...
                                    success: function (result) {
                                        ...
                                        if (result.companyName == "현대택배") {
                                            ...
                                            window.open(
                                                'http://www.dhl.com/cgi-bin/tracking.pl?awb=' +
                                                result.trackingNumber +
                                                '&LAN=KOR&TID=KR_KOR&LINKS=NO',
                                                '배송조회'); //배송조회
                                        } else if (result.companyName.indexOf("우체국") > -
                                            1) {
                                        ...
                                        } else if (result.companyName.indexOf(
                                                "CJ대한통운") > -1) {
                                            window.open(result.cjUrl, '배송조회',
                                                'width=850, height=850'); //배송조회
                                        } else if (result.companyName.indexOf("굿투럭") > -
                                            1) {
                                            ...
                                            layerAlert(result.companyName + "<br />" +
                                                result.trackingNumber);
                                        }
                    ...
                    var globalCancelRequest = function (code) {
                        ...
                        alertTag +=
                            '            <p class="pop_txt_190911">mypage.order.history.list.global.cancel.message1</p>';
                        alertTag +=
                            '            <p class="pop_txt_190911">mypage.order.history.list.global.cancel.message2</p>';
                        if ("ko" == "zh") {
                            alertTag +=
                        ...
                        alertTag +=
                            '                <input type="button" class="btn gray_s mr0" value="text.button.ok">';
                        alertTag += '            </div>';
                        alertTag += '        </div>';
                        alertTag +=
                    ...
                    var globalCancelLayerAlert = function (tag) {
                        ...
                        $alertLayer.find('.popwrap').css('marginTop', getMarginTop($alertLayer.find('.popwrap')
                            .outerHeight()));
                    ...
                    function getExchangeRate(price) {
                        ...
                        var exchangeRate = "199.66";
                        var symbol = "¥";

                        if ("ko" == "en") {
                            if (currencyCode == "USD") {
                                return symbol + " " + addComma(Math.round(parseFloat(price) / parseFloat(exchangeRate) *
                                    100) / 100);
                            }
                        } else {
                            if (currencyCode == "CNY") {
                    ...
                    function membershipMergeInfoPopup() {
                        ...
                        popupTag +=
                            '	<div class="popwrap w_type_1 membership-alert" style="z-index: 150; margin-top: 220px;" tabindex="-1">';
                ...
                <div class="profile_info1 clearfix review_betterment1905">
                    <div class="name type2">
                        <span class="ico_grade">박서은&nbsp;<span>님</span></span>
                    ...
                    <div class="point type2">
                        <p class="title2">간편회원은 H.Point / 한섬마일리지 적립과 사용이 불가합니다. <br />혜택을 받으시려면, H.Point 통합회원으로 가입해주세요.
                        </p>
                ...
                <div class="title_wrap">
                    <h4 class="float_left">최근주문
                        <!-- 최근주문 -->
                    </h4>
                    <p class="txt_line">최근 1개월 내 주문하신 내역입니다.
                        <!-- 최근 1개월 내 주문하신 내역 입니다. -->
                    </p>
                    <div class="btn_wrap">
                        <a href="/ko/mypage/order/myorders" class="btn add_ss"
                            onclick="GA_Event('마이페이지','최근주문','전체보기');">전체보기
                            <!-- 전체보기 --></a>
                    </div>
                </div>
                <!-- table -->
                    ...
                    <table class="tbl_ltype review_betterment1905">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col" style="padding:15px 0">수량
                                    <!-- 수량 -->
                                </th><!-- 스타일추가 181204 -->
                                <th scope="col">판매가
                                    <!-- 판매가 -->
                        ...
                        <tbody id="listBody">
                            <tr class="al_middle">
                                <td rowspan="2" class="frt">
                                    <p class="num">221012P15336437</p><span class="sum_date">(2022.10.12)</span><a
                                        href="/ko/mypage/order/myorderdetail?code=221012P15336437" class="btn_view"
                                        onclick="GA_Event('마이페이지','최근주문','상세보기');">상세보기</a>
                                </td>
                                <td>
                                    <div class="pt_list_all"> <a href="/ko/p/YS2D1ACK001WHD_BK_FR"
                                            onclick="GA_Event('마이페이지','최근주문','%5BHIDDEN%20FOREST%20MARKET%5D%20%uCE94%uB514%20%uD3EC%uC778%uD2B8%20%uC591%uB9D0');"><img
                                                src="http://newmedia.thehandsome.com/YS/2D/SS/YS2D1ACK001WHD_BK_S01.jpg"
                                                alt="상품 이미지"></a>
                                        <div class="tlt_wrap"> <a href="/ko/p/YS2D1ACK001WHD_BK_FR" class="basket_tlt"
                                                onclick="GA_Event('마이페이지','최근주문','%5BHIDDEN%20FOREST%20MARKET%5D%20%uCE94%uB514%20%uD3EC%uC778%uD2B8%20%uC591%uB9D0');">
                                                <span class="tlt">[FOURM THE STORE]</span> <span class="sb_tlt">[HIDDEN
                                                    FOREST MARKET] 캔디 포인트 양말</span> </a>
                                            <p class="color_op">color : BLACK <span class="and_line">/</span> size : FR
                                            </p>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr class="al_middle">
                                <td>
                                    <div class="pt_list_all"> <a href="/ko/p/YN2C9ACK491W_BG_FR"
                                            onclick="GA_Event('마이페이지','최근주문','%uC6B8%20%uBE14%uB80C%uB4DC%20%uBA5C%uB780%uC9C0%20%uC591%uB9D0');"><img
                                                src="http://newmedia.thehandsome.com/YN/2C/FW/YN2C9ACK491W_BG_S01.jpg"
                                                alt="상품 이미지"></a>
                                        <div class="tlt_wrap"> <a href="/ko/p/YN2C9ACK491W_BG_FR" class="basket_tlt"
                                                onclick="GA_Event('마이페이지','최근주문','%uC6B8%20%uBE14%uB80C%uB4DC%20%uBA5C%uB780%uC9C0%20%uC591%uB9D0');">
                                                <span class="tlt">[FOURM THE STORE]</span> <span class="sb_tlt">울 블렌드
                                                    멜란지 양말</span> </a>
                                            <p class="color_op">color : BEIGE <span class="and_line">/</span> size : FR
                                            </p>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr class="al_middle">
                                <td rowspan="1" class="frt">
                                    <p class="num">221011P15326951</p><span class="sum_date">(2022.10.11)</span><a
                                        href="/ko/mypage/order/myorderdetail?code=221011P15326951" class="btn_view"
                                        onclick="GA_Event('마이페이지','최근주문','상세보기');">상세보기</a>
                                </td>
                                <td>
                                    <div class="pt_list_all"> <a href="/ko/p/YN2C9ACK492W_IV_FR"
                                            onclick="GA_Event('마이페이지','최근주문','%uC6B8%20%uBE14%uB80C%uB4DC%20%uD50C%uB85C%uB7F4%20%uC790%uC218%20%uC591%uB9D0');"><img
                                                src="http://newmedia.thehandsome.com/YN/2C/FW/YN2C9ACK492W_IV_S01.jpg"
                                                alt="상품 이미지"></a>
                                        <div class="tlt_wrap"> <a href="/ko/p/YN2C9ACK492W_IV_FR" class="basket_tlt"
                                                onclick="GA_Event('마이페이지','최근주문','%uC6B8%20%uBE14%uB80C%uB4DC%20%uD50C%uB85C%uB7F4%20%uC790%uC218%20%uC591%uB9D0');">
                                                <span class="tlt">[FOURM THE STORE]</span> <span class="sb_tlt">울 블렌드
                                                    플로럴 자수 양말</span> </a>
                                            <p class="color_op">color : IVORY <span class="and_line">/</span> size : FR
                                            </p>
                                        </div>
                                    </div>
                                </td>
                ...
                <ul class="wish_wrap">
                    <li>
                        <a href="/ko/p/TG2C9ACK002WDI" class="a_link" onclick="GA_Mypage('wish',$(this));">
                            <img src="http://newmedia.thehandsome.com/TG/2C/FW/TG2C9ACK002WDI_ML_S01.jpg" alt="상품 이미지">
                            <span class="brand">TOM GREYHOUND</span>
                            <span class="tlt">[ADIDAS] 미드 컷 크루 양말 세트</span>
                        </a>
                        <span class="prie">
                            ￦ 22,000</span>
                    </li>
                    <li>
                        <a href="/ko/p/TH2CAWJM336M" class="a_link" onclick="GA_Mypage('wish',$(this));">
                            <img src="http://newmedia.thehandsome.com/TH/2C/FW/TH2CAWJM336M_BK_S01.jpg" alt="상품 이미지">
                            <span class="brand">TIME HOMME</span>
                            <span class="tlt">크링클 드로우스트링 점퍼</span>
                        </a>
                        <span class="prie">
                            ￦ 930,000</span>
                    </li>
    ...
    <script type="text/javascript">
        ...
        function reviewWriteHtml(categoryCode, returnType) {
            ...
            if ("ko" == "ko") {
                ...
                reviewhtml +=
                    "                                 <strong class='reqd' style='margin-top:1px;'>*</strong>";
                reviewhtml += "                                 상품평<br/>";
    ...
    <noscript>
        <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5PCJDFJ" height="0" width="0"
...
<script language='javascript'>
    var _AceGID = (function () {
        var Inf = ['dgc17.acecounter.com', '8080', 'AP6F40149814536', 'CW', '0', 'NaPm,Ncisy', 'ALL', '0'];
...
<noscript><img src='http://dgc17.acecounter.com:8080/?uid=AP6F40149814536&je=n&' border='0' width='0' height='0'
        alt=''></noscript>
...
<script type="text/javascript">
    ...
    document.writeln();
    var TRS_URL = TRS_PROTOCOL + '//' + ((TRS_PROTOCOL == 'https:') ? 'analysis.adinsight.co.kr' :
...
<div class="popwrap w_type_4" id="addrModPop" style="display:none;">
    ...
    <div class="title_wrap">
        <h4 class="float_left">
            <spring:theme code="global.delivery.modaddr" /><!-- 배송지 수정 -->
        </h4>
        <p class="reqd_txt none"><strong class="reqd">*</strong> 표시는 필수항목입니다.
            <!-- 표시는 필수항목입니다. -->
        </p>
    </div>
    <!-- //Title1 -->
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="ph2" title="연락처 가운데자리" class="hp_num2" numberOnly="true"
                                maxlength="4" />
                            <div class="form_hyphen">-</div>
                            <input type="text" id="ph3" title="연락처 뒷자리" class="hp_num2" numberOnly="true"
                                maxlength="4" />
                            <!-- //hp -->
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td id="orderrArea">
                            ...
                            <div class="delivery_comt" style="display:none;">
                                <ul>
                                    <li class="deliveryMsg"><a href="#;" deliveryRequestMessage="배송 전 연락 바랍니다">배송 전 연락
                                            바랍니다</a></li>
                                    <li class="deliveryMsg"><a href="#;" deliveryRequestMessage="부재 시 문 앞에 놓아주세요">부재 시 문
                                            앞에 놓아주세요</a></li>
                                    <li class="deliveryMsg"><a href="#;" deliveryRequestMessage="부재 시 경비실에 맡겨주세요">부재 시
                                            경비실에 맡겨주세요</a></li>
                                    <li class="deliveryMsg"><a href="#;" deliveryRequestMessage="빠른 배송 부탁드립니다">빠른 배송
                                            부탁드립니다</a></li>
                                    <li class="deliveryMsg"><a href="#;" deliveryRequestMessage="부재 시 핸드폰으로 연락바랍니다">부재 시
                                            핸드폰으로 연락바랍니다</a></li>
                                </ul>
                            </div>
                        </td>
...
<div class="popwrap w_type_5" id="globalReturnLayer" style="display:none;">
    ...
    <div class="pop_cnt">
        <div class="glb_return">
            <p class="return_msg">
                To request any return, please send E-mail to hsglobal@thehandsome.com specifying order number, product
                name and the reason for returning.<br><br>
                Shipping fee for returning would be charged as follows and deducted from refund amount. Please check the
                amount before you continue return.</p>
...
<div class="popwrap w_type_4" style="display:none;" id="globalAddressModify">
    <!-- Title1 -->
    <div class="title_wrap">
        <h4 class="mb10">배송정보 수정
            <!-- 배송지 수정 -->
        </h4>
        <p class="reqd_txt">표시는 필수항목입니다.
            <!-- 표시는 필수항목입니다. -->
        </p>
    </div>
    <!-- //Title1 -->
            ...
            <table class="tbl_wtype1">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select id="countryCode" name="countryCode" title="Select Your Country" style="width:300px"
                                disabled="disabled">
                    ...
                    <tr>
                        <th scope="row"><strong class="reqd">*</strong><label
                                for="firstname">mypage.delivery.pc.firstName</label></th>
                        <td>
                            <input value="" title="mypage.delivery.pc.firstName" name="firstname" id="firstname"
                                type="text" style="width:435px;" />
                        </td>
                    </tr>
                    <tr>
                        <th scope="row"><strong class="reqd">*</strong><label
                                for="name">mypage.delivery.pc.lastName</label></th>
                        <td>
                            <input value="" title="mypage.delivery.pc.lastName" name="lastname" id="name" type="text"
                                style="width:435px;" />
                        </td>
                    </tr>
                    <tr>
                        <th scope="row"><strong class="reqd">*</strong><label
                                for="localFirstName">mypage.delivery.pc.localFirstName</label></th>
                        <td>
                            <input value="" title="mypage.delivery.pc.localFirstName" name="localFirstName"
                                id="localFirstName" type="text" style="width:435px;" />
                        </td>
                    </tr>
                    <tr>
                        <th scope="row"><strong class="reqd">*</strong><label
                                for="name">mypage.delivery.pc.localLastName</label></th>
                        <td>
                            <input value="" title="mypage.delivery.pc.localLastName" name="localLastName"
                                id="localLastName" type="text" style="width:435px;" />
                        </td>
                    </tr>
                    <tr>
                        <th scope="row"><strong class="reqd">*</strong><label
                        ...
                        <td>
                            <div class="input_sumtxt">
                                <div class="input_sumtxt_box">
                                    <!-- input -->
                                    <input id="address1" name="streetname" type="text" value="" title="Street address"
                                        style="width:435px;" />
                                    <!-- //input -->
                                </div>
                                <div>
                    ...
                    <tr>
                        <th scope="row" class="th_space"><label for="Street2">mypage.delivery.pc.streetAddress2</label>
                        </th>
                        <td>
                            <div class="input_sumtxt">
                                <div class="input_sumtxt_box">
                                    <!-- input -->
                                    <input id="address2" name="streetnumber" type="text" value="" title="Street address"
                                        style="width:435px;" />
                                    <!-- //input -->
                                </div>
                                <div>
                    ...
                    <tr>
                        <th scope="row"><strong class="reqd">*</strong><label for="City">mypage.delivery.pc.city</label>
                        </th>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input value="" title="수령인" id="zipCode" name="postalcode" type="text"
                                style="width:300px;" />
                    ...
                    <tr>
                        ...
                        <td>
                            <input value="" title="수령인" name="cellphone" id="cellphone" type="text"
                                style="width:300px;" />
    ...
    <div class="pop_cnt">
        ...
        <div class="btnwrap">
            <input type="button" id="returnCancelBtn" class="btn wt_s mr5"
                value="mypage.order.history.list.global.refund.cancel" style="min-width:120px;">
            <input type="button" id="returnBtn" class="btn gray_s mr0"
                value="mypage.order.history.list.global.refund.confirm" style="min-width:120px;">
        </div>
    </div>
    <a href="#" class="btn_close"><img src="/_ui/desktop/common/images/popup/ico_close.png" alt="닫기"></a>
</div>
