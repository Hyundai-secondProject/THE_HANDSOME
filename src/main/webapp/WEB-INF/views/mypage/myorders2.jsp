...
<script type="text/javascript">
		...
		var ACC = { config: {} };
			...
			ACC.config.CSRFToken = "68c5cb8a-c60c-49a3-b908-ff7a61970324";
...
function callChatbot(token, talkId) {
    if(token == null) {
        $.ajax({
            ...
            data: {"CSRFToken":"68c5cb8a-c60c-49a3-b908-ff7a61970324"},
            async : false,
            success:function(data){
				...
				<div class="top_nav_wrap clearfix">
					...
					<div class="search_box_wrap sbw1803" id="searchBox">
						<form name="search" id="search" action="/ko/hssearch/searchCount"
							...
							<input type="hidden" name="CSRFToken"
								value="68c5cb8a-c60c-49a3-b908-ff7a61970324" /> <input
