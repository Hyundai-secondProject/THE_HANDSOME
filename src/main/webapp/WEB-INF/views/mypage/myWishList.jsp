    ...
    <script>
        $(document).ready(function () {
            ...
            if (todayDate.getTime() >= startDate.getTime() && todayDate.getTime() <= endDate.getTime()) {
                ...
                var referer = "https://www.thehandsome.com/ko/mypage/order/myorders";
            ...
            <script type="text/javascript">
                ...
                $(document).ready(function () {
                    ...
                    if ("PASS" != "") {
                        ...
                        if ((vipPassCheck == "Y" || timePassCheck == "Y") && "myWishListPage" ==
                            "main201903Page") {
                            $('#chatbotMain').show();
                        } else {
                            $('#chatbotMain').hide();
...
<!-- AceCounter END -->
<tbl_lt!-- AceCounter Log Gathering Script V.7.5.2013010701 -->
    <script language='javascript'>
        var _AceGID = (function () {
            ...
            if (_CI.join('.').indexOf(Inf[3]) < 0) {
                _T.src = (location.protocol == "https:" ? "https://" + Inf[0] : "http://" + Inf[0] + ":" + Inf[
                    1]) + '/?cookie';
                _CI.push(Inf);
                _N = _CI.length;
            }
        ...
        var _AceCounter = (function () {
            ...
            if (G.o != 0) {
                ...
                var _S = ((['<scr', 'ipt', 'type="text/javascr', 'ipt"></scr', 'ipt>']).join('')).replace('tt',
                    't src="' + location.protocol + '//cr.acecounter.com/Web/AceCounter_' + _C + '.js?gc=' +
                    _A[2] + '&py=' + _A[4] + '&gd=' + _G + '&gp=' + _A[1] + '&up=' + _U + '&rd=' + (
                        new Date().getTime()) + '" t');
                document.writeln(_S);
                return _S;
            }
