...
<script type="text/javascript">
		...
		var ACC = { config: {} };
			...
			ACC.config.CSRFToken = "df9d8776-a73b-4bcd-a344-ab3f4bcf95f0";
...
<input type="hidden" name="CSRFToken" value="df9d8776-a73b-4bcd-a344-ab3f4bcf95f0" />
</div></form><!-- headerWrap -->
		<div id="headerWrap" >
...
function callChatbot(token, talkId) {
    if(token == null) {
        $.ajax({
            ...
            data: {"CSRFToken":"df9d8776-a73b-4bcd-a344-ab3f4bcf95f0"},
            async : false,
            success:function(data){
                    ...
                    <div class="data_react">
                        ...
                        <div class="search_tab">
                            ...
                            <form id="searchStyle" name="searchStyle" action="/ko/hssearch/searchCount" method="post" onsubmit="return false;">
                                ...
                                <input type="hidden" name="collection" value=""/>
                                <input type="hidden" id="CSRFToken" name="CSRFToken" value="df9d8776-a73b-4bcd-a344-ab3f4bcf95f0" />
...
<input type="hidden" name="CSRFToken" value="df9d8776-a73b-4bcd-a344-ab3f4bcf95f0" />
    ...
    <div class="util_menu util_menu1803">
        <ul class="clearfix">
            ...
            <li><a href="/ko/shoppingbag" onclick="GA_Event('공통','유틸_메뉴','쇼핑백');"><span class="ico cart">장바구니</span> <span class="count">(<span id="cartCount">1</span>)</span></a></li>
            </ul>
    </div>
  </div>  
    <!-- //201803 util menu -->
...
function uploadFilesubmit(writeType, returnType) {
	...
	if ( fileSize <= 1 ) {
		...
		$.ajax({
			url	 : url + '?CSRFToken=df9d8776-a73b-4bcd-a344-ab3f4bcf95f0',
			type	: 'POST',
			dataType: 'json',
			data	: param,
			success : function(data) {
