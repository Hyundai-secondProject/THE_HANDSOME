			...
			<div class="cnts2_right">
				...
				<div id="noticeWrap" class="notice">
					...
					<div class="list">
						...
						<ul class="list_new" style="top: -20px;"><li><a href="/ko/svcenter/notice?noticeCode=8804481683376">[당첨자발표] 핸썸TV 라이브 방송(10/13) 방송 중 이벤트 당첨 결과 안내</a></li><li><a href="/ko/svcenter/notice?noticeCode=8804481781680">[당첨자 발표] 더한섬닷컴 22년 9월 베스트 리뷰 TOP5 선정 안내</a></li><li><a href="/ko/svcenter/notice?noticeCode=8804481716144">[당첨자 발표] 10월 뷰티 릴레이 체험단 당첨</a></li><li><a href="/ko/svcenter/notice?noticeCode=8804481748912">카카오페이 결제서비스 복구완료 안내</a></li></ul>
					</div>
				</div>
				<!-- //공지 -->
				...
				<div id="newsWrap" class="news">
					...
					<div class="list">
						...
						<ul class="list_new" style="top: -20px;"><li><a href="/ko/magazine/newsDetailtemplatetype4?newsCode=8804154136348&amp;typeCode=WEB" onclick="GA_Common('news',$(this))">[핸썸TV] 더한섬닷컴 7주년, 광고 속 아이템 찾기</a></li><li><a href="/ko/magazine/newsDetailtemplatetype4?newsCode=8804219574044&amp;typeCode=WEB" onclick="GA_Common('news',$(this))">클럽모나코 X 배우 남지현 브이로그 2편 공개</a></li><li><a href="/ko/magazine/newsDetailtemplatetype4?newsCode=8804219541276&amp;typeCode=WEB" onclick="GA_Common('news',$(this))">[핸썸TV] 시스템X한국타이어 팝업 LIVE in 성수</a></li><li><a href="/ko/magazine/newsDetailtemplatetype4?newsCode=8804186773276&amp;typeCode=WEB" onclick="GA_Common('news',$(this))">배우 김고은의 더한섬닷컴 7주년 축하 영상 공개</a></li></ul>
					</div>
				</div>
				<!-- //뉴스 -->
				<!-- // 푸터 공지 추가 220404 -->
...
var birthday = 'Thu Jan 16 00:00:00 UTC 1997';
...
</script><script src="http://cr.acecounter.com/Web/AceCounter_CW.js?gc=AP6F40149814536&amp;py=0&amp;gd=dgc17&amp;gp=8080&amp;up=NaPm_Ncisy&amp;rd=1666062567953" type="text/javascript"></script>
