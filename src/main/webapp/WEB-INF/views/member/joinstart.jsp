				...
				<fieldset>
					...
					<div class="box_type_1">
						<div class="email ">
							...
							<p class="emailinput">
								<input type="text" id="uid" name="uid" style="width: 120px"
									title="이메일 아이디"> <span class="andmail">@</span> <input
									type="text" id="uidDomain" name="uidDomain"
									style="width: 120px; display: none;" title="이메일 계정"> <select
									id="uidDomainSel" style="width: 120px; margin: 0 0 0 0;"
									title="이메일 아이디 도메인">
								...
								</select> <input type="button" class="btn add_s" id="idDubChkBtn"
									value="중복확인"> <br> <span class="guide_comment"
									id="idDubMsg"></span><br> <input type="text"
									placeholder="인증번호 입력" id="email_auth_key"> <input
									type="button" id="email_auth_btn"
									class="email_auth_btn btn add_s" value="인증 번호 받기">
							</p>
