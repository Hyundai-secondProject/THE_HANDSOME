...
<link rel="stylesheet" type="text/css" href="/resources/css/contents.css?20220907" media="all" />
...
<script type="text/javascript">
		...
		var ACC = { config: {} };
			...
			ACC.config.CSRFToken = "18eaaf69-7050-431a-8f10-3f0b82404f6e";
...
var setDimensionData = function(){
    ...
    var pageviewObj = new Object();
     ...
     //로그인 했을경우만 추가 dimension 세팅
       ...
       pageviewObj.dimension2 = "65080861";                  //고객_회원번호
       ...
       pageviewObj.dimension7 = "bFoEgTqCFa8W9BbFlI9DLQ==";                  //고객_생년 => 고객_통합멤버십번호 변경됨
       ...
       pageviewObj.dimension14 = "20221004";                //고객_회원가입일
       pageviewObj.userId = "65080861";                      //사용자ID
...
//     var startDate = new Date('2018/03/23 00:00:00'), endDate = new Date('2018/04/08 23:59:59');
    if (todayDate.getTime() >= startDate.getTime() && todayDate.getTime() <= endDate.getTime()) {
        ...
        var referer = "https://stdpay.inicis.com/";
	 ...
	 //   recoPick('sendLog','order', {id:'상품id', count:상품개수, total_sales:상품별총가격}); 
	    ...
	    var tmpPrice      = '';
	     ...
	     //aa
	           /*
	           legacy code
	           productId = "LB2C8ACK428U";
	           productMap.set(productId, '1');
	           totalPriceMap.set(productId, parseFloat('23000.0'));
	           */
	           
				productId = "LB2C8ACK428U"; 
	           
	        	// 2020.03.31 hmk
				mapSet( productMap, productId, "", "" ) ;
				mapSet( totalPriceMap, productId, "23000.0", "23000.0" ) ;
	         
	     
	  	// 2020.03.31 hmk
	    var itemAarry = new Array();
	    for( var i ; i < productMap.length ; i++ ) {
	    	for( var j ; j < totalPriceMap.length ; j++ ) {
	    		if( productMap[i].key === totalPriceMap[j].key ) {
	    			itemAarry.push( {
	    	    		id : productMap[i].key
	    	    		, count : productMap[i].value
	    	    		, total_sales : totalPriceMap[j].value
	    	    	} ) ;
	    		}
	    	}
	    }
	    ...
	    legacy code
	     ...
	     for (var [key, value] of productMap) {
	        ...
	        for (var [key2, value2] of totalPriceMap) {
	            if(key == key2) {
	                itemInfo.total_sales = value2;
	                itemAarry.push(itemInfo);
	            }
	        } 
	     }
	     */
		 ...
		 try{
		      recoPick('sendLog','order',itemAarry); // recoPick('sendLog','order', {id:'상품id', count:상품개수, total_sales:상품별총가격});    
		 }catch(e) {
		      console.log(e);
		 }
...
<!-- Groobee -->
    ...
    <!-- End of Groobee -->
    <meta property="groobee:member_id" content="wkdwndus0409"/>
...
// 								html.push('<li><a href="http://www.thehyundai.com/front/dpm/myShopHome.thd?bfp=Ref_Handsome">트렌드샵</a></li>');
	...
	<form id="CSRFForm" action="/ko/checkout/orderConfirmation" method="post"><div>
<input type="hidden" name="CSRFToken" value="18eaaf69-7050-431a-8f10-3f0b82404f6e" />
</div></form><!-- headerWrap -->
		<div id="headerWrap" >
...
function callChatbot(token, talkId) {
    if(token == null) {
        $.ajax({
            ...
            data: {"CSRFToken":"18eaaf69-7050-431a-8f10-3f0b82404f6e"},
            async : false,
            success:function(data){
...
$(document).ready(function() {
    ...
    if("PASS" != ""){
	    ...
	    if ((vipPassCheck == "Y" || timePassCheck == "Y") && "orderConfirmationPage" == "main201903Page") {
	        $('#chatbotMain').show(); 
	    }else{
	        $('#chatbotMain').hide(); 
	    }
                    ...
                    <div class="data_react">
                        ...
                        <div class="search_tab">
                            ...
                            <form id="searchStyle" name="searchStyle" action="/ko/hssearch/searchCount" method="post" onsubmit="return false;">
                                ...
                                <input type="hidden" name="collection" value=""/>
                                <input type="hidden" id="CSRFToken" name="CSRFToken" value="18eaaf69-7050-431a-8f10-3f0b82404f6e" />
...
<input type="hidden" name="CSRFToken" value="18eaaf69-7050-431a-8f10-3f0b82404f6e" />
    ...
    <div class="util_menu util_menu1803">
        <ul class="clearfix">
            ...
            <li><a href="/ko/mypage/myWish" onclick="GA_Event('공통','유틸_메뉴','위시리스트');"><span class="ico wishlist">wish list</span> <span class="count">(<span id="wishlistCount">2</span>)</span></a></li>
...
window.criteo_q.push(
        ...
        { event: "trackTransaction", id: "221014P15365577", item: [
            
            { id: "LB2C8ACK428U", price: "23000", quantity: "1"}
        //], requiresDOM: "yes"});
          ]});
</script>
<!--  criteo 구매전환 페이지 트래커 END ---->

<!--  #1072 구매전환 테스트 코드(애드게더요청) -->
<!-- Google Code for &#44396;&#47588;&#50756;&#47308; Conversion Page -->
<script type="text/javascript">
/* <![CDATA[ */
var google_conversion_id = 943253288;
var google_conversion_label = "EJthCNWkuHsQqM7jwQM";
var google_conversion_value = "25500";
...
<noscript>
    <div style="display:inline;">
        <img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/943253288/?value=25500&amp;currency_code=USD&amp;label=EJthCNWkuHsQqM7jwQM&amp;guid=ON&amp;script=0"/>
    </div>
</noscript>
<!--  #1072 구매전환 테스트 코드(애드게더요청) -->
...
var	ENP_TOTALQTY = 0;
var ENP_TOTALPRICE = 0;
// 주문한 각 제품들을 배열에 저장

ENP_TOTALQTY += 1;
ENP_TOTALPRICE += 23000;
ENP_VAR.conversion.product.push(
		{
			productCode : 'LB2C8ACK428U',
			productName : '레터링 골프 양말',
			price : '23000.0',
			dcPrice : '0',
			qty : '1'
		}
...
ENP_VAR.conversion.ordCode= '221014P15365577';
ENP_VAR.conversion.totalPrice = ENP_TOTALPRICE;
ENP_VAR.conversion.totalQty = ENP_TOTALQTY;

(function(a,g,e,n,t){a.enp=a.enp||function(){(a.enp.q=a.enp.q||[]).push(arguments)};n=g.createElement(e);n.async=!0;n.defer=!0;n.src="https://cdn.megadata.co.kr/dist/prod/enp_tracker_self_hosted.min.js";t=g.getElementsByTagName(e)[0];t.parentNode.insertBefore(n,t)})(window,document,"script");
enp('create', 'conversion', 'thehandsome', { device: 'W' }); // W:웹, M: 모바일, B: 반응형
enp('send', 'conversion', 'thehandsome');
</script>
...
var google_conversion_label = "XVRUCM7J4GEQqM7jwQM";
var google_conversion_value = '25500';
...
<noscript>
<div style="display:inline;">
<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/943253288/?value=25500&amp;currency_code=KRW&amp;label=XVRUCM7J4GEQqM7jwQM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>

<!--Adgather Click Conversion start-->
<!-- 애드게더 스크립트 삽입 -->
<script language="javascript">
    var SEA_others1=""; 
    
    
       SEA_others1 += "레터링 골프 양말";
...
<!-- 애드게더 스크립트 삽입 -->
<!--Adgather Click Conversion end-->
<!--Beshow Script Start -->
<script type="text/javascript" src="https://www.be.show/plugins/strack/strack.min.js"></script>
<!--Beshow Script End -->
<script type="text/javascript">
//<![CDATA[  
$(document).ready(function ()
{
	//20220826 our regacy 
		...
		var commissionAgreeYN = "N";
		$.ajax({
	    	type: "POST",
	    	url: "/ko/checkout/sendCommissionAgreementInfo",
	    	data : {
	    		"checkYN" : commissionAgreeYN,
	    		"CSRFToken": "18eaaf69-7050-431a-8f10-3f0b82404f6e",
	    		},
	    	success: function(data){
	    ...
	    function dupleCheck(code,qty){
		    var noduple = {};
		    var stFlag = false;
		    if(returnResult.length > 0){
			    returnResult.filter(function (object){
			        if(object["id"] === code){
			            object["id"] = code;
			            object["quantity"] = object.quantity + qty;
			            stFlag = true;
			        }
			    });
			    if(!stFlag){
				    noduple["id"] = code;
				    noduple["quantity"] = qty;
				    returnResult.push(noduple);
			    }
			}else{
			    noduple["id"] = code;
			    noduple["quantity"] = qty;
	    ...
	    dupleCheck('LB2C8ACK428U', 1);
	
	    
	    
// 	    var contents = "";
// 	    $.each(returnResult, function(index) {
// 	        contents += JSON.stringify(this);
// 	        if(index !== returnResult.length-1){
// 	            contents += ",";
// 	        }
// 	    })
    
        window._fbq.push (['track', 'Purchase',{'value':'25500.0','currency':'KRW'
            , contents: returnResult
    ...
    <!-- 버츄 사이즈 -->
	    ...
	    if(virtusizeViewYn){
	            ...
	            vs.setApiKey("591c366309ee9a2e724a2276f108de2d73968cbf");
	            
	            var orderObject = {
	                   // 주문 오브젝트
	                   orderId: "221014P15365577",
	                   userId: "wkdwndus0409",
	                   region: "KR",
	                   // 아이템 오브젝트
	                   items: [
	                      ...
	                      {
	                          productId: "LB2C8ACK428U_BK",
	                          
	                                   size:      "S",
	                                  
	                          url:       "https://www.thehandsome.com:443/HANDSOME/GOLF/ACC-/Socks/%EB%A0%88%ED%84%B0%EB%A7%81-%EA%B3%A8%ED%94%84-%EC%96%91%EB%A7%90/p/LB2C8ACK428U_BK_S",   
	                          
	                                  imageUrl: "http://newmedia.thehandsome.com/LB/2C/FW/LB2C8ACK428U_BK_S01.jpg",
	                              
	                          unitPrice: parseFloat('23000.0'),
	                          quantity:  1,
	                          currency:  "KRW"
	                      }
    ...
    if(giftEventPopYn == "true"){
        popYn = true;
    }
    
    setEcommerceData();
    var TRS_ORDER_PRODUCT = undefined;
	...
	$("#agreeOera, #disagreeOera").on("click", function(){
		var commissionAction = $(this).attr('id').replace('Oera','');
		$.ajax({
        	type: "POST",
        	url: '/ko/rest/checkout/commission/oera/221014P15365577/'+commissionAction+'?CSRFToken=18eaaf69-7050-431a-8f10-3f0b82404f6e',
        	dataType: "json",
        	async:false,
        	...
        	success: function(data){
				if( data ){
			    	if( data == 1 ){
			        	if( commissionAction == 'agree' ){
			            	$(".oera-mileage-accumulation-guide").hide();
				        	$(".oera-mileage-accumulation-guide.type2").show();
			        	}else{
			            	$(".oera-mileage-accumulation-guide").show();
				        	$(".oera-mileage-accumulation-guide.type2").hide();
			        	}
			    	}else{
			        	console.log(data)
			        	layerAlert("일시적인 오류가 발생하였습니다.<br/>잠시 후 다시 이용해 주세요");
			    	}     
				}else{
			    	console.log('data is undefined!');
		        	layerAlert("예기치 않은 오류가 발생하였습니다.<br/>잠시 후 다시 이용해 주세요");
				}
        	},
...
function myordersAthomePage() {
    location.href = "/ko/mypage/order/myordersAthome";
}

function setEcommerceData(){
    var v_dimension20 = '';
    ...
    dataLayer.push({
	    'event': 'ga_event', 'layerCategory' : 'Ecommerce', 'layerAction' : 'Purchase','layerLabel' : undefined,'nonInteraction' : true, 'dimension20': v_dimension20,
	    'metric1': '0', 'metric2': '0', 'metric3': '0', 'metric4': '0', 'metric5': '0', 'metric6': '23000', 'metric7': '23000', 'metric8': '23000',
	    'ecommerce': {
	    'currencyCode': 'KRW', //통화
	    'purchase': {
		    'actionField': {"id": "221014P15365577", "revenue": "25500", "shipping": "2500", "coupon": gaCoupon },
		    'products':
			    [
			    
			        {
			            
					    "id": "LB2C8ACK428U", //상품코드
					    "name": "레터링 골프 양말", //상품명
					    "brand": "LANVIN BLANC", //상품 브랜드
					    
					    "category": decodeURIComponent("GOLF")+"/"+decodeURIComponent("ACC-")+"/"+decodeURIComponent("SOCKS"), //상품 카테고리
					    
					    "variant": "BLACK_S", //변형 제품(옵션)
					    "price": "23000", //상품 가격
					    "quantity": "1", //상품 수량
...
function viewPopup(v){
    ...
    if(tp < 0) tp=0;
    $("#productLayer").show();
    obj.css("top", tp).css("position", "absolute").css("z-index", 99999);
    obj.show();
}
...
function sendGroobee(){
    ...
    groobee( "PU", {
        orderNo : "221014P15365577",
        goods : [
        
            {
                name: "레터링 골프 양말", // 상품명
                code: "LB2C8ACK428U", // URL에 표시되는 상품코드
                amt: "23000", // 상품 금액 (할인 판매가 * 수량)
                prc: "23000", // 판매가 (또는 원가)
                salePrc:"23000", // 할인 판매가 (실제 판매가)
                cnt: "1", // 수량
                cat: "GF035", // 상품의 카테고리 코드
                cateNm: "양말", // 상품의 카테고리명
                catL: "GF", // 상품의 대분류 카테고리 코드
                cateLNm: "골프", // 상품의 대분류 카테고리명
                catM: "GF03", // 상품의 중분류 카테고리 코드
                cateMNm: "ACC", // 상품의 중분류 카테고리명
                catS: "GF035", // 상품의 소분류 카테고리 코드
                cateSNm: "양말", // 상품의 소분류 카테고리명
                            ...
                            <tr class="al_middle">
                                    <td class="frt">
                                        ...
                                        <div class="pt_list_all">
                                            ...
                                            <div class="tlt_wrap">
                                                <a href="/ko/HANDSOME/GOLF/ACC-/Socks/%EB%A0%88%ED%84%B0%EB%A7%81-%EA%B3%A8%ED%94%84-%EC%96%91%EB%A7%90/p/LB2C8ACK428U_BK_S" class="basket_tlt">
                                                    <span class="tlt">LANVIN BLANC</span>
                                                    <span class="sb_tlt">레터링 골프 양말</span>                                                            
                                                    </a>
                                                
                                                <p class="color_op">
                                                            
                                                                color : BLACK<span class="and_line">/</span>
                                ...
                                <script language='javascript' type="text/javascript">
                                    ...
                                    _A_pl[_ace_countvar]='LB2C8ACK428U_BK_S';       
                                    _A_pn[_ace_countvar]='레터링 골프 양말';    
                                ...
                                strack.execute('setOrderItemLink', '/ko/HANDSOME/GOLF/ACC-/Socks/%EB%A0%88%ED%84%B0%EB%A7%81-%EA%B3%A8%ED%94%84-%EC%96%91%EB%A7%90/p/LB2C8ACK428U_BK_S'); 
                                strack.execute('setOrderItemImage', 'http://newmedia.thehandsome.com/LB/2C/FW/LB2C8ACK428U_BK_S01.jpg'); 
								...
								<script type="text/javascript"> 
								 if(typeof TRS_PRODUCT == 'undefined') {
								  ...
								  TRS_PRODUCT = TRS_PRODUCT + ' $ '+ 'LB2C8ACK428U_BK_S'; // 상품아이디 변수(상품코드)
								  TRS_ORDER_PRODUCT += ' $ ' + 'LB2C8ACK428U_BK_S' + '@' + '레터링 골프 양말' + '@' + '23000' + '@' + '1';
								 }
								</script>
...
<a href="#;" onclick="myordersPage();"><input value="주문내역조회" class="btn wt" type="button" /></a>
                   <a href="#;" onclick="continuePage();"><input value="쇼핑계속하기" class="btn gray mr0" type="button" /></a>
                </div>
            </div>
            <!--//sub_container--> 
        </div>
        ...
        <script language='javascript' type="text/javascript">
        var _AEC_order_code='221014P15365577';        // 주문코드
        var _amt = '25500';              // 총 구매액 
        AEC_B_L();          // 구매완료 함수
        </script>
        ...
        strack.execute('setOrderId', '221014P15365577'); 
        strack.execute('setOrderPrice', '25500'); 
        ...
        if(typeof kakaoPixel !== 'undefined'){
			...
			kakaoPixel(kakaoTrackId).purchase({
				...
				total_price: "25500",  // 주문 총 가격(optional)
				currency: "KRW",     // 주문 가격의 화폐 단위(optional, 기본 값은 KRW)
				products: // 주문 내 상품 정보(optional)
				    [          
					    
					    { name: '레터링 골프 양말', quantity: "1", price: '23000'}
				    ]
			});
        }
		</script>
		...
		<script language='javascript'> 
		 var TRS_AMT= '25500';	// 구매금액합계 변수 
		 var TRS_ORDER_ID='221014P15365577'; // 주문번호
		</script>
...
<p>딜리버리 서비스 &#62;</p>
    ...
    <script type="text/javascript" src="//wcs.naver.net/wcslog.js"></script>
        <script type="text/javascript">
	        var _nasa={};
	        var totalprice_cnv = "25500";
	        _nasa["cnv"] = wcs.cnv("1",totalprice_cnv); // 주문완료 전환유형, 전환가치
        </script>
