...
<script type="text/javascript">
		...
		var ACC = { config: {} };
			...
			ACC.config.CSRFToken = "563dc39e-b7d1-4dde-8f0b-ca86e4f255b0";
...
var setDimensionData = function(){
    ...
    var pageviewObj = new Object();
     ...
     //로그인 했을경우만 추가 dimension 세팅
       ...
       pageviewObj.dimension14 = "20221007";                //고객_회원가입일
...
//     var startDate = new Date('2018/03/23 00:00:00'), endDate = new Date('2018/04/08 23:59:59');
    if (todayDate.getTime() >= startDate.getTime() && todayDate.getTime() <= endDate.getTime()) {
        ...
        var referer = "http://www.thehandsome.com/ko/shoppingbag";
...
try{
	var birthday = 'Sat Aug 09 00:00:00 UTC 1997';
	...
	recoPick('service', 'thehandsome.com/ko/');   
		 ...
		 * 
		 * ie 호환성 문제로 변경
		 * 크롬에서 Map object api 사용하여 정상 작동 되나 
		 * ie 11.426.nnn 버전 이하에서 작동 불가 확인하여 pure js로 수정
		 */
		var productMap = [] ;
	    ...
	    var tmpQuntity   = '';
	 	...
	 	// 2020.03.31 hmk
	 	// productMap이 배열이므로 그냥 자연스럽게 for loop 수행하면 됨.
...
<!-- Groobee -->
    ...
    <!-- End of Groobee -->
    <meta property="groobee:member_id" content="ehfhfh1313@naver.com"/>
    ...
    <meta property="groobee:member_age" content="26"/>
    <script>
    // 검색 결과 페이지
    if(window.location.pathname.indexOf("/hssearch/searchCount") > -1) {
...
<!-- <div id="transparent_mask"></div> -->
	...
	<form id="CSRFForm" action="/ko/shoppingbag?cartDivision=" method="post"><div>
...
function callChatbot(token, talkId) {
    if(token == null) {
        $.ajax({
            ...
            data: {"CSRFToken":"563dc39e-b7d1-4dde-8f0b-ca86e4f255b0"},
            async : false,
            success:function(data){
            ...
            <ul class="clearfix">
                <!-- 선호 브랜드 있음 -->
	                    <li><span class="on"><a href="/ko/main" onclick="GA_Event('공통','탑_네비게이션','HOME')">HOME</a></span></li>
	                        <li><span><a href="/ko/c/br63/br63" onclick="GA_Common('topNav',$(this))">LANVIN BLANC</a></span></li>
	                                    <li><span><a href="/ko/b/br08" onclick="GA_Common('topNav',$(this))">the CASHMERE</a></span></li>                                
	                                    <li><span><a href="/ko/c/br44/br44" onclick="GA_Common('topNav',$(this))">CLUB MONACO</a></span></li>
	                                    <li><span><a href="/ko/c/br15/br15" onclick="GA_Common('topNav',$(this))">TOM GREYHOUND</a></span></li>
	                                    <li><span><a href="/ko/c/br35/br35" onclick="GA_Common('topNav',$(this))">FOURM THE STORE</a></span></li>
	                                    <li><span><a href="/ko/c/br30/br30" onclick="GA_Common('topNav',$(this))">FOURM STUDIO</a></span></li>
	                                    <!-- 공간 상 들어가지 못한 나머지 브랜드-->
	                        <div class="plus_brand header_dropmemu">
	                            <a href="javascript:void(0);" class="btn"><span>plus</span></a>
	                            <div class="list">
	                                <ul>
	                                    <li><span><a href="/ko/c/br32/br32" onclick="GA_Common('topNav',$(this))">FOURM MEN'S LOUNGE</a></span></li>
	                                            </ul>
	                            </div>
	                        </div>
	                    </ul>
                    ...
                    <div class="data_react">
                        ...
                        <div class="search_tab">
                            ...
                            <form id="searchStyle" name="searchStyle" action="/ko/hssearch/searchCount" method="post" onsubmit="return false;">
                                ...
                                <input type="hidden" name="collection" value=""/>
                                <input type="hidden" id="CSRFToken" name="CSRFToken" value="563dc39e-b7d1-4dde-8f0b-ca86e4f255b0" />
